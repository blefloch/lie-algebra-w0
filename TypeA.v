...
(*TODOs for this file :
  - Perhaps use something like the following.
    ...
    Variable Hrad : is_radical g lambda = true.
*)
...
Section A123.
  ...
  Theorem thm_main_A1 :
    forall g lambda Hn,
      ...
      -> (Is_nonmixed g lambda) \/ (Is_mixed g lambda).
  Proof.
...
Section exceptional_structure.
  Theorem thm_A_zero_exceptional :
    forall g,
      ...
      -> Is_nonmixed g (repeat 0%Z (lie_embedding_dim g)).
  Proof.
    intros g Hgtype.
    destruct g as [[n Hn]| | | | | | | | ] ;
...
Section main.
  ...
  Proof.
    ...
    - intros n IHn Hn2 lambda.
      ...
      + intros Hrad.
        unfold is_radical, lie_algebra_type in Hrad.
        autorewrite with rewritesome in Hrad.
        ...
        assert (is_radical h mu = true) as Hradalgmu.
        {
          unfold is_radical.
          simpl_extra.
          split.
        ...
        { simpl ; trivial. }
        assert (is_radical g lambda = true) as Hradalglambda.
        {
          unfold is_radical.
          simpl_extra.
          split ; assumption.
        ...
        * destruct (thm_A_exceptional_structure h Hhtype mu Hmuexc)
          ...
          }
          {
            ...
            - right.
              assert (is_radical h nu = true) as Hradalgnu.
              {
                unfold is_radical.
                simpl_extra.
                unfold Is_known_w0_branching_A_revwt,
